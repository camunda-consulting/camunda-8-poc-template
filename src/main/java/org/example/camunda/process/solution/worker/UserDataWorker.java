...
public class UserDataWorker {
  ...
  public void get(final JobClient client, final ActivatedJob job) throws IOException {
    ...
    client
        ...
        .send()
        // join(); <-- This would block for the result. While this is easier-to-read code, it has
        // limitations for parallel work.
        // Hence, the following code leverages reactive programming. This is discssed in
